...
// users.forEach(tempBlock => {tempBlock.registrationDate == '09.10.2021' || tempBlock.registrationDate == '10.10.2021' ? console.log(tempBlock):''})

const usersfiltered = users.filter((users) => {
    if (users.registrationDate === '09.10.2021' || users.registrationDate === '10.10.2021') {
        return users;
    }
})
